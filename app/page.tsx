...
export default function Portfolio() {
  ...
  return (
    <div className={`min-h-screen bg-transparent text-foreground relative transition-colors duration-300 font-sans selection:bg-accent selection:text-accent-foreground`}>
          ...
          <ScrollReveal>
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-7xl font-bold tracking-tight mb-4">
                Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f89820] to-[#5382a1]">Saurabh Kumar Singh</span>
              </h1>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div id="about" className="relative mb-20 md:mb-48 md:ml-auto md:w-[45%] md:pr-12 text-center md:text-left group">
          ...
          <button
            ...
            className="absolute hidden md:block w-6 h-6 rounded-full bg-accent top-10 -left-[calc(5.5%+12px)] shadow-[0_0_15px_#f89820] border-4 border-black z-10 hover:scale-150 transition-transform cursor-pointer"
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div className="w-full md:w-1/4 flex-shrink-0">
                      <div className="relative w-full aspect-[2/3] rounded-lg overflow-hidden border-2 border-accent/30 shadow-[0_0_20px_rgba(248,152,32,0.3)]">
                        <Image
                          src="/m1.jpeg"
                          alt="Profile"
                          fill
                    ...
                    <div className="flex-1 flex flex-col gap-6">
                      ...
                      {/* Inspirational Quote */}
                      <div className="p-6 rounded-lg border-2 border-accent/40 bg-gradient-to-br from-accent/10 to-accent/5 shadow-[0_0_15px_rgba(248,152,32,0.2)]">
        ...
        <div id="skills" className="relative mb-20 md:mb-48 md:mr-auto md:w-[45%] md:pl-12 text-center md:text-right group">
          ...
          <button
            ...
            className="absolute hidden md:block w-6 h-6 rounded-full bg-accent top-10 -right-[calc(5.5%+12px)] shadow-[0_0_15px_#f89820] border-4 border-black z-10 hover:scale-150 transition-transform cursor-pointer"
        ...
        <div id="activities" className="relative mb-20 md:mb-48 md:mr-auto md:w-[45%] md:pl-12 text-center md:text-right group">
          {/* Connector Dot */}
          < div className="absolute hidden md:block w-4 h-4 rounded-full bg-accent top-10 -right-[calc(5.5%+9px)] shadow-[0_0_10px_#f89820]" ></div >
      ...
      <footer className="py-8 border-t border-accent/10 text-center text-muted-foreground bg-[#0b1120]">
